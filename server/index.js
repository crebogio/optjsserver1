...
const insertSeirenHazai = require("./routes/insertSeirenHazai");
const inKneading = require("./routes/inKneading");
const inRolling = require("./routes/inRolling");
const inCutting = require("./routes/inCutting");
...
app.use("/api/v1/insertSeirenHazai", insertSeirenHazai);
app.use("/api/v1/inKneading", inKneading);
app.use("/api/v1/inRolling", inRolling);
app.use("/api/v1/inCutting", inCutting);
